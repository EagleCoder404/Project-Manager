...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="sign-up-box">
        ...
        <tr>
          <td><input type="number" name="sem" value="" size="1" min="0" max="8" required placeholder="Semester"><br></td>
        </tr>
        <tr>
          <td><input type="text" name="branch" value="" size="3" maxlength="3" required placeholder="Branch"><br></td>
        </tr>
        <tr>
